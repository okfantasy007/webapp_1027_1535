Ext.define('Admin.view.inventory.inventoryCardView', {
    extend: 'Ext.container.Container',

    requires: [
        'Admin.view.base.PagedGrid'
    ],
    xtype: 'inventoryCardView',
    // 指定布局
    layout: 'card',
    // 指定panel边缘的阴影效果
    cls: 'shadow',
    viewModel: {
        stores: {
            ...
            card_grid_store: {
                ...
                proxy: {
                    type: 'ajax',
                    url: 'rest/inventory/res_card/select/page',
                    reader: {
                        type: 'json',
                        rootProperty: 'data'
                    }
                    ...
                    beforeload: function(store, options) {
                        ...
                        if(ary.length > 2){
                            if(ary[2] == "chassis_id"){
                                ...
                                Ext.apply(store.proxy.extraParams, {search_id:ary[2] + "='" + base_id + "'",type:"web_router",card_type:"0"});
                            }
                            else{
                                Ext.apply(store.proxy.extraParams,  {search_id:ary[2] + "=" + ary[3],type:"web_router",card_type:"0"});
                            }
                        }
                        else{
                            Ext.apply(store.proxy.extraParams, {card_type:"0"});
                        }    
                    }
                }
            }
    ...
    controller: {
        onToRouteView: function(me , e , eOpts){
            var grid = this.lookupReference('cardGrid'),
        ...
        onActive: function(me, eOpts) {
            ...
            if(ary.length > 2){
                store.proxy.url="rest/inventory/res_card/select/page"
                store.proxy.extraParams = {card_id:ary[2],type:"web_router",card_type:"0"};
            }
            else{
        ...
        onEdit: function() {
            var grid = this.lookupReference('cardGrid'),
                form = this.lookupReference('card_edit_form'),
            ...
            form.setTitle(_("local Card Edit Info"));
        },
        onProperty: function() {
            var grid = this.lookupReference('cardGrid'),
                form = this.lookupReference('card_edit_form'),
            ...
            form.setTitle(_('local Card Properties Info'));
        },
        onDelete: function() {
            var grid = this.lookupReference('cardGrid'),
                records = grid.getSelectionModel().getSelection(), 
        ...
        onItemDoubleClick: function( me , record , item , index , e , eOpts ) {
            var form = this.lookupReference('card_edit_form');
            this.loadFormRecord(form, record);
            form.getForm().getFields().each(function(field) {  
                //设置只读  
                field.setReadOnly(false);    
        ...
        onReset: function() {
            this.lookupReference('card_edit_form').getForm().reset();
        },
    ...
    items: [
    {
                    ...
                    items: [// Reset and Submit buttons
                        {
                            ...
                            handler: function() {
                                ...
                                store.proxy.url="rest/inventory/res_card/select/page"
                                store.proxy.extraParams = {card_type:"0"};
                                store.reload();
                            }
                        },
                        {
        ...
        }, 
        {
            ...
            columns: [
                ...
                { text: _('Card Name'), dataIndex: 'userlabel', width: 135 },
                { text: _('Card Type'), dataIndex: 'card_type_display_name', width: 130 },
                { 
                ...
                { text: _('Card Desc'), dataIndex: 'card_desc', width: 100 },
                { text: _('Update Time'), dataIndex: 'update_time', width: 160, 
                    renderer:Ext.util.Format.dateRenderer('Y-m-d H:i:s') 
                },
                { text: _('Sync Time'), dataIndex: 'last_sync_time', width: 160, 
                    renderer:Ext.util.Format.dateRenderer('Y-m-d H:i:s') 
                },
                ...
                { xtype: 'hidden', text: 'Mib值', dataIndex: 'identifier_value', width: 90 },
                {xtype: 'hidden', text: _('MAC Address'), dataIndex: 'macaddress', width: 100 },
                {xtype: 'hidden', text: _('Card Name'), dataIndex: 'card_name', width: 135 },
            ...
            items: [
                {
                    ...
                    },
                    {
                        ...
                        hidden:SEC.hidden('01010502'),
                        handler: 'onDelete',
                        bind: {
                            disabled: '{!cardGrid.selection}'
                        }                    
                    },
                    {
                        text: _('Refresh'),
                ...
                },
                {
                    ...
                    menu: [
                    {
                        ...
                        handler : function() {
                            ...
                            location.href = "/inventory/res_card/export/datacsv?" + Ext.Object.toQueryString(send_info)
                        } 
                    },
                    {
    ...
    {
        title: _("local Card Edit Info"),
        xtype: 'form',
        reference: 'card_edit_form',
        margin: 10,
        items: [
        {
            xtype: 'fieldset',
