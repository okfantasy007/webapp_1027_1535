Ext.define('Admin.view.performance.historyTask.view.template', {
	...
	requires: [
		...
		'Admin.view.performance.historyTask.controller.templateControl',
	],
			...
			items: [
				{
					...
					xtype: 'grid',
					region: 'north',
					reference: 'quotaTemplateGrid',
					itemId: 'quotaTemplateGrid',
					// 绑定到viewModel的属性
					bind: {
...

				{
					...
					dockedItems: [
						...
						},
						{
							...
							hidden: true,
							height: 50,
							itemId: 'thresholdTempSerchForm',
							reference: 'thresholdTempSerchForm',
