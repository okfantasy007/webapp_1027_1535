Ext.define('Admin.view.performance.historyTask.view.singleUpdTemplate', {
	...
	requires: [
		...
		'Admin.view.performance.historyTask.controller.singleUpdTemplate',
	],
	controller: 'singleUpdTemplate',
	viewModel: 'templateViewModel',
	reference: 'singleUpdTemplate',
	itemId: 'singleUpdTemplate',
	layout: 'card',
	cls: 'shadow',
	items: [
		{
			...
			items: [
				{
					...
					xtype: 'grid',
					region: 'north',
					reference: 'singleUpdQuotaTemplateGrid',
					itemId: 'singleUpdQuotaTemplateGrid',
					// 绑定到viewModel的属性
					bind: {
					...
					dockedItems: [
						{
							...
							//dock: 'top',
							dock: 'bottom',
							itemId: 'singleUpdThresholdToobar',
							inputItemWidth: 80,
							displayInfo: true,
						...
						},
						{
							...
							hidden: true,
							height: 50,
							itemId: 'singleUpdThresholdTempSerchForm',
							reference: 'singleUpdThresholdTempSerchForm',
