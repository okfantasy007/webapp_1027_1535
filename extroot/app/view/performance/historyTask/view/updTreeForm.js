Ext.define('Admin.view.performance.historyTask.view.updTreeForm', {
	//extend: 'Admin.view.base.CardForm',
	extend: 'Ext.container.Container',
	xtype: 'updTreeForm',
	requires: [
		'Admin.view.performance.historyTask.model.reStoreModel',
		'Admin.view.performance.historyTask.viewModel.updTreeFormViewModel',
		'Admin.view.performance.historyTask.controller.updTreeFormControl',
		'Admin.view.performance.historyTask.view.resourceTree',
	],
	controller: 'updTreeFormControl',
	viewModel: 'updTreeFormViewModel',
	reference: 'updTreeForm',
	itemId: 'updTreeForm',
	margin: 10,
	items: [
		{
			...
			reference: 'updResourceView',
			itemId: 'updResourceView',
			...
			items: [
				...
				},
				{
					...
					xtype: 'grid',
					reference: 'updSourceGrid',
					region: 'east',
					frame: true,
					itemId: 'updSourceGrid',
					//height: 2000,
					width: 900,
					autoScroll: true,//滚动条
					// 绑定到viewModel的属性
