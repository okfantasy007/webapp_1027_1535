Ext.define('Admin.view.performance.templateMangement.view.userLeftTree.userPMLeftTree', {
    extend: 'Ext.tree.Panel',
    requires: [
        'Admin.view.performance.templateMangement.viewModel.userLeftTree.userPMLeftTree',
        'Admin.view.performance.templateMangement.model.userLeftTree.userPMLeftTree',
        'Admin.view.performance.templateMangement.controller.userLeftTree.userPMLeftTree'
    ],
    xtype: 'userPMLeftTree',
    viewModel: 'userPMLeftTree',
    itemId: 'treepanel',
    reference: 'treepanel',
    controller: 'userPMLeftTree',
    rootVisible: true,
    useArrows: true,
