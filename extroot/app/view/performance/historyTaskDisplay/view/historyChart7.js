Ext.define('Admin.view.performance.historyTaskDisplay.view.historyChart7', {
	xtype: 'historyChart7',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.historyTaskDisplay.controller.historyChart7',
								...
								'-',
								{
									...
									listeners: {
										change: function (me, newValue, oldValue, ops) {
											...
											var chart = this.up().up().up().down('#chart7');
