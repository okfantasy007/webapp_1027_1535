Ext.define('Admin.view.performance.historyTaskDisplay.view.historyChart3', {
	xtype: 'historyChart3',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.historyTaskDisplay.controller.historyChart3',
								...
								'-',
								{
									...
									listeners: {
										change: function (me, newValue, oldValue, ops) {
											...
											var chart = this.up().up().up().down('#chart3');
