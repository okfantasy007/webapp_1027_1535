Ext.define('Admin.view.performance.historyTaskDisplay.view.historyChart5', {
	xtype: 'historyChart5',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.historyTaskDisplay.controller.historyChart5',
								...
								'-',
								{
									...
									listeners: {
										change: function (me, newValue, oldValue, ops) {
											...
											var chart = this.up().up().up().down('#chart5');
