Ext.define('Admin.view.performance.historyTaskDisplay.view.historyChart6', {
	xtype: 'historyChart6',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.historyTaskDisplay.controller.historyChart6',
								...
								'-',
								{
									...
									listeners: {
										change: function (me, newValue, oldValue, ops) {
											...
											var chart = this.up().up().up().down('#chart6');
