Ext.define('Admin.view.performance.historyTaskDisplay.view.historyChart9', {
	xtype: 'historyChart9',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.historyTaskDisplay.controller.historyChart9',
								...
								'-',
								{
									...
									listeners: {
										change: function (me, newValue, oldValue, ops) {
											...
											var chart = this.up().up().up().down('#chart9');
