Ext.define('Admin.view.performance.historyTaskDisplay.view.historyChart2', {
	xtype: 'historyChart2',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.historyTaskDisplay.controller.historyChart2',
								...
								'-',
								{
									...
									listeners: {
										change: function (me, newValue, oldValue, ops) {
											...
											var chart = this.up().up().up().down('#chart2');
