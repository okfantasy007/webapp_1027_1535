Ext.define('Admin.view.performance.historyTaskDisplay.view.hisMetricTree', {
	extend: 'Ext.tree.Panel',
	xtype: 'hisMetricTree',
	controller: {
		onExpandAll: function () {
			card = this.getView().up();
			resourceTree = card.down('#hisMetricTree');
	...
	store: {
		...
		proxy: {
			type: 'ajax',
			url: '/pmManagement/api/pmmng/pmTaskDetai/findMetricByResource',
			reader: {
				type: 'json',
