Ext.define('Admin.view.performance.historyTaskDisplay.controller.historyChart10', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.historyChart10',
    onAxisLabelRender: function (axis, label, layoutContext) {
        return label.toFixed(label < 10 ? 1 : 0);
    },
    //图形导出
    export: function () {
        var chart = this.getView().up().up().down('#chart10');
