Ext.define('Admin.view.performance.historyTaskDisplay.controller.historyChart4', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.historyChart4',
    onAxisLabelRender: function (axis, label, layoutContext) {
        return label.toFixed(label < 10 ? 1 : 0);
    },
    //图形导出
    export: function () {
        var chart = this.getView().up().up().down('#chart4');
    ...
    onToggleMarkers: function () {
        var chart = this.lookupReference('chart4'),
