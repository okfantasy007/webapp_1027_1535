Ext.define('Admin.view.performance.historyTaskDisplay.controller.historyChart7', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.historyChart7',
    onAxisLabelRender: function (axis, label, layoutContext) {
        return label.toFixed(label < 10 ? 1 : 0);
    },
    //图形导出
    export: function () {
        var chart = this.getView().up().up().down('#chart7');
    ...
    onToggleMarkers: function () {
        var chart = this.lookupReference('chart7'),
