Ext.define('Admin.view.performance.realTimeTask.view.realChart8', {
	xtype: 'realChart8',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.realTimeTask.controller.realChart8',
		'Ext.grid.plugin.Exporter',
		'Ext.exporter.text.CSV',
	],
	controller: 'realChart8',
	items: [
		{
			xtype: 'panel',
			itemId: 'chart8View',
