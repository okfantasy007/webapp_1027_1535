Ext.define('Admin.view.performance.realTimeTask.view.realChart5', {
	xtype: 'realChart5',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.realTimeTask.controller.realChart5',
		'Ext.grid.plugin.Exporter',
		'Ext.exporter.text.CSV',
	],
	controller: 'realChart5',
	items: [
		{
			xtype: 'panel',
			itemId: 'chart5View',
