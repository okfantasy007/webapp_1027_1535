Ext.define('Admin.view.performance.realTimeTask.view.realChart6', {
	xtype: 'realChart6',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.realTimeTask.controller.realChart6',
		'Ext.grid.plugin.Exporter',
		'Ext.exporter.text.CSV',
	],
	controller: 'realChart6',
	items: [
		{
			xtype: 'panel',
			itemId: 'chart6View',
