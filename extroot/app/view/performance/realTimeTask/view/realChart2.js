Ext.define('Admin.view.performance.realTimeTask.view.realChart2', {
	xtype: 'realChart2',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.realTimeTask.controller.realChart2',
		'Ext.grid.plugin.Exporter',
		'Ext.exporter.text.CSV',
	],
	controller: 'realChart2',
	items: [
		{
			xtype: 'panel',
			itemId: 'chart2View',
