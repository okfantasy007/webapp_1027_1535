Ext.define('Admin.view.performance.realTimeTask.view.realChart3', {
	xtype: 'realChart3',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.realTimeTask.controller.realChart3',
		'Ext.grid.plugin.Exporter',
		'Ext.exporter.text.CSV',
	],
	controller: 'realChart3',
	items: [
		{
			xtype: 'panel',
			itemId: 'chart3View',
