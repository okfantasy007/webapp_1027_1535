Ext.define('Admin.view.performance.realTimeTask.view.realChart4', {
	xtype: 'realChart4',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.realTimeTask.controller.realChart4',
		'Ext.grid.plugin.Exporter',
		'Ext.exporter.text.CSV',
	],
	controller: 'realChart4',
	items: [
		{
			xtype: 'panel',
			itemId: 'chart4View',
