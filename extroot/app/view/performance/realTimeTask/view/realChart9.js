Ext.define('Admin.view.performance.realTimeTask.view.realChart9', {
	xtype: 'realChart9',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.realTimeTask.controller.realChart9',
		'Ext.grid.plugin.Exporter',
		'Ext.exporter.text.CSV',
	],
	controller: 'realChart9',
	items: [
		{
			xtype: 'panel',
			itemId: 'chart9View',
