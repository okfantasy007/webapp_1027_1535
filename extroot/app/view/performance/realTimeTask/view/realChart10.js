Ext.define('Admin.view.performance.realTimeTask.view.realChart10', {
	xtype: 'realChart10',
	extend: 'Ext.panel.Panel',
	requires: [
		'Admin.view.performance.realTimeTask.controller.realChart10',
		'Ext.grid.plugin.Exporter',
		'Ext.exporter.text.CSV',
	],
	controller: 'realChart10',
	items: [
		{
			xtype: 'panel',
			itemId: 'chart10View',
			...
			items: [
				...
				},
				{
					//性能任务表
					xtype: 'gridpanel',
					itemId: 'displayGrid10',
					reference: 'displayGrid10',
