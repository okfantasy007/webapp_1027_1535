Ext.define('Admin.view.performance.realTimeTask.controller.realChart6', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.realChart6',
    //实时性能图导出
    export: function () {
        chart = this.getView().up().up().down('#realChart6');
    ...
    doExport: function (config) {
        this.getView().up().up().down('#displayGrid6').saveDocumentAs(config);
    },
