Ext.define('Admin.view.performance.realTimeTask.controller.realChart9', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.realChart9',
    //实时性能图导出
    export: function () {
        chart = this.getView().up().up().down('#realChart9');
    ...
    doExport: function (config) {
        this.getView().up().up().down('#displayGrid9').saveDocumentAs(config);
    },
