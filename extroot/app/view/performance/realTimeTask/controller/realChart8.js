Ext.define('Admin.view.performance.realTimeTask.controller.realChart8', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.realChart8',
    //实时性能图导出
    export: function () {
        chart = this.getView().up().up().down('#realChart8');
    ...
    doExport: function (config) {
        this.getView().up().up().down('#displayGrid8').saveDocumentAs(config);
    },
