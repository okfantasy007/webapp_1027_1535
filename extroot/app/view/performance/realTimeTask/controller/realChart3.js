Ext.define('Admin.view.performance.realTimeTask.controller.realChart3', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.realChart3',
    //实时性能图导出
    export: function () {
        chart = this.getView().up().up().down('#realChart3');
    ...
    doExport: function (config) {
        this.getView().up().up().down('#displayGrid3').saveDocumentAs(config);
    },
