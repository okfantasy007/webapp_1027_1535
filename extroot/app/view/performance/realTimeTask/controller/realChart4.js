Ext.define('Admin.view.performance.realTimeTask.controller.realChart4', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.realChart4',
    //实时性能图导出
    export: function () {
        chart = this.getView().up().up().down('#realChart4');
    ...
    doExport: function (config) {
        this.getView().up().up().down('#displayGrid4').saveDocumentAs(config);
    },
