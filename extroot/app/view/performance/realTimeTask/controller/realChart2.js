Ext.define('Admin.view.performance.realTimeTask.controller.realChart2', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.realChart2',
    //实时性能图导出
    export: function () {
        chart = this.getView().up().up().down('#realChart2');
    ...
    doExport: function (config) {
        this.getView().up().up().down('#displayGrid2').saveDocumentAs(config);
    },
    ...
    resourceNames: function () {
        var resourceForm = this.getView().up().up().down('#resourceForm')
