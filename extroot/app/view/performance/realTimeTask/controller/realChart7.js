Ext.define('Admin.view.performance.realTimeTask.controller.realChart7', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.realChart7',
    //实时性能图导出
    export: function () {
        chart = this.getView().up().up().down('#realChart7');
    ...
    doExport: function (config) {
        this.getView().up().up().down('#displayGrid7').saveDocumentAs(config);
    },
