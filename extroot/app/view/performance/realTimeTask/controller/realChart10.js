Ext.define('Admin.view.performance.realTimeTask.controller.realChart10', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.realChart10',
    //实时性能图导出
    export: function () {
        chart = this.getView().up().up().down('#realChart10');
    ...
    doExport: function (config) {
        this.getView().up().up().down('#displayGrid10').saveDocumentAs(config);
    },
