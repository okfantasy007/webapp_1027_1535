Ext.define('Admin.view.configcenter.view.dataBackup.strategy.editDataBackupStrategy', {
	extend: 'Ext.container.Container',
	xtype: 'editDataBackupStrategy',
	requires: [
		'Admin.view.configcenter.store.date',
	],

	items: [{
		xtype: 'form',
		itemId: 'editPolicyForm',
		ftpType: 'backup',
		levelId: 0,
		items: [{
			xtype: 'fieldset',
			title: _("Edit Backup Policy"),
			fieldDefaults: {
				labelAlign: 'right',
				labelWidth: 110,
			},
