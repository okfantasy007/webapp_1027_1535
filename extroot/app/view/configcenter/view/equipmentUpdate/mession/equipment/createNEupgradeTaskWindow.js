Ext.define('Admin.view.configcenter.view.equipmentUpdate.mession.equipment.createNEupgradeTaskWindow', {
	extend: 'Ext.container.Container',
	xtype: 'createNEupgradeTaskWindow',
	requires: [
		'Admin.view.configcenter.store.ftpIp',
		'Admin.view.configcenter.store.ftpUsers',
	],
	items: [{
		xtype: 'form',
		levelId: 0,
