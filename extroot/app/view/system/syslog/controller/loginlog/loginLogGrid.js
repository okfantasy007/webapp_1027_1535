Ext.define('Admin.view.system.syslog.controller.loginlog.loginLogGrid', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.loginLogGrid',
	...
	onQueryCondition:function(){
        var grid = this.getView().down('#loginLogGrid');
		...
		store.proxy.url="/syslog/api/log/v1/loginlog";
