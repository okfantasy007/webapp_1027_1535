Ext.define('Admin.view.system.syslog.controller.devoperatelog.devOpLogGrid', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.devOpLogGrid',
	...
	onQueryCondition:function(){
        var grid = this.getView().down('#devOpLogGrid');
		...
		store.proxy.url="/syslog/api/log/v1/syslog";
