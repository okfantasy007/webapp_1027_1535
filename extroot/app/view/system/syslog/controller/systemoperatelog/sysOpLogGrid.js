Ext.define('Admin.view.system.syslog.controller.systemoperatelog.sysOpLogGrid', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.sysOpLogGrid',
	...
	onQueryCondition:function(){
        var grid = this.getView().down('#sysOpLogGrid');
        ...
        store.proxy.url="/syslog/api/log/v1/oplog";
