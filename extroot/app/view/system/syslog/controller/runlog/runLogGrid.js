Ext.define('Admin.view.system.syslog.controller.runlog.runLogGrid', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.runLogGrid',
	...
	onQueryCondition:function(){
        var grid = this.getView().down('#runLogGrid');
		...
		store.proxy.url="/syslog/api/log/v1/runlog";
