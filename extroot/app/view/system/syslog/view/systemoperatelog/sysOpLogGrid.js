Ext.define('Admin.view.system.syslog.view.systemoperatelog.sysOpLogGrid', {
    extend: 'Ext.container.Container',
    xtype: 'SysOpLogView',
    requires: [
        'Admin.view.system.syslog.model.systemoperatelog.sysOpLogGrid',
        'Admin.view.system.syslog.viewModel.systemoperatelog.sysOpLogGrid',
        // 'Ext.ux.DateTimeField',
        'Admin.view.system.syslog.controller.systemoperatelog.sysOpLogGrid'
    ],
    controller: 'sysOpLogGrid',
    viewModel: 'sysOpLogGrid',  
    layout: 'card',
	// 指定panel边缘的阴影效果
    cls: 'shadow',
	...
	items:[
		{
            ...
            columns: [
                ...
                {
                    text: _('logs_operateName'),
                    dataIndex: 'operateName',
                    hideable: false,
                    width: 180
                },
                {
                    text: _('logs_operateObject'),
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'textfield',
                                    fieldLabel:_('logs_operateName'),
                                    name:'operateName'
                                },
                                {
                                    xtype: 'textfield',
                                    fieldLabel:_('logs_operateObject'),
                                    name:'operateObject'
                                },
                                {
                                    xtype: 'textfield',
