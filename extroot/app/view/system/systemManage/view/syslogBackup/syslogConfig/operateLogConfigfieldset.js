Ext.define('Admin.view.system.systemManage.view.syslogBackup.syslogConfig.operateLogConfigfieldset', {
	            ...
	            },
	        	{
	                ...
	                items: [
	               	   ...
	               	   },
	                   {
	           	          ...
	           	          columns: 2,
	           	          vertical: true,
	           	          itemId: 'operateLogProctolType',
	           	          items: [
	           	        	{ boxLabel: 'UDP', name: 'operateLogProctolType', inputValue: 0, checked: true},
	           	            { boxLabel: 'TCP', name: 'operateLogProctolType', inputValue: 1 },
	           	          ]
	               	   },
	               	   {
	 		             ...
	 		             maxLength: 20,
	 		             labelWidth:110,
	 		             itemId: 'operateLogServerIp',
	 		             name:'operateLogServerIp',
	 			         vtype: 'IPAddress',
		 	          },
 	                  {
