Ext.define('Admin.view.topology.main.topoSubnetGridView', {
    extend: 'Ext.container.Container',

    requires: [
        'Admin.view.base.PagedGrid'
    ],
    xtype: 'topoSubnetGridView',
    // 指定布局
    layout: 'card',
    // 指定panel边缘的阴影效果
    cls: 'shadow',
    ...
    viewModel: {
        stores: {
            ...
            subnet_grid_store: {
                ...
                proxy: {
                    type: 'ajax',
                    url: '/topo/topo_subnet/subnet_info',
                    extraParams: {
                        param: ''
                    },
                    reader: {
    ...
    controller: {
        onRefresh: function() {
            this.lookupReference('subnetGrid').getStore().reload();
        },
        onChange: function(newValue, oldValue, eOpts) {
            var grid = this.lookupReference('subnetGrid');
        ...
        onExportAll:function(){
            var grid = this.lookupReference('subnetGrid');
            location.href ="/topo/topo_subnet/subnet_info/exportAll/datacsv?"+Ext.Object.toQueryString(grid.store.proxy.extraParams);
        },
        onExportCurrentPage:function(){
            ...
            location.href ="/topo/topo_subnet/subnet_info/exportCurrentPage/datacsv?"+Ext.Object.toQueryString(params);
        },
        onExportSelected:function(){
            ...
            for (var i in records) {
             ...
             send_info.ids=ids;
            location.href = "/topo/topo_subnet/subnet_info/exportSelected/datacsv?" + Ext.Object.toQueryString(send_info);
        }
    },
