Ext.define('Admin.view.alarms.alarmStatistics.currentAlarmStatisticsGridView', {
    extend: 'Ext.container.Container',
    xtype: 'currentAlarmStatisticsGridView',
            ...
            statistics_remote: {
              ...
              // 每页显示记录数
               pageSize: 15,
				        proxy: {
				            type: 'ajax',
				            url: '/alarm/alarmReport/getCurrent',
				            actionMethods : {  
				                read   : 'GET'
				            },
				            reader: {
    ...
    controller: {
        ...
        onExportAll:function(){
             ...
             Ext.Array.each(columns,function(item,index,columns){
        	  ...
        	  location.href = "/alarm/alarmReport/exportCurrent?fields="+Ext.JSON.encode(fields)+"&dataIndex="+Ext.JSON.encode(dataIndex);
        },
        ...
        onExportCurrentPage:function(){
             ...
             location.href = "/alarm/alarmReport/exportCurrent?currentPage="+store.currentPage+"&pageSize="+store.pageSize+"&fields="+fieldsStr+"&dataIndex="+dataIndexStr;
        },
