Ext.define('Admin.view.alarms.AlarmReparExp.editForm', {
    extend: 'Ext.container.Container',
    xtype:'editForm',
    initItems: function() {
        this.callParent();
        this.sel2delete = new Array();
        this.sel2add = new Array();
    },
    controller: { 
                onAdd: function(){
            ...
            return popWindow;
                ...
                onDelete: function(){
                    ...
                    var sel2delete = container.sel2delete;
                    var gridStore = grid.getStore();
                    var gridStoreData = gridStore.getData();
                    for(var i in selection){
                            if(selection[i].get('iRCAlarmLogID')==null){
                                sel2delete.push(selection[i]);
                            }
                        }
