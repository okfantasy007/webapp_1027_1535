	...
	[
		...
		function(conn,rows,callback){	
			...
			if(nextLoginModifyPwd==1){
				sql = 'update sec_user_strategy  set change_password_next_login = 1,cannot_change_password=0 where sec_user_id = '+userId ;
			}else{
				sql ="update sec_user_strategy set change_password_next_login = '0' where sec_user_id = "+userId ;
			}
